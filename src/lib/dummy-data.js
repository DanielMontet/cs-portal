...
function createOrderData(orderId, amount, status, pending) {
    return { orderId: orderId, amount: amount, status: status, pending: pending };
}
var orders = [
...
export var getOrders = function () {
    return orders;
};
export var getMeals = function () {
    return meals;
};
